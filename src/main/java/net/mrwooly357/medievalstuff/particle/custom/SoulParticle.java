...
public class SoulParticle extends AnimatedParticle {

    protected SoulParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider provider) {
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(SimpleParticleType ignoredType, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new SoulParticle(world, x, y, z, velocityX, velocityY, velocityZ, provider);
        }
    }
}
