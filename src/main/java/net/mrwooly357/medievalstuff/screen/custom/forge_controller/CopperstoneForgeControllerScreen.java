...
public class CopperstoneForgeControllerScreen extends ForgeControllerScreen<CopperstoneForgeControllerScreenHandler> {
    ...
    private static final Identifier MELTING_PROGRESS_TEXTURE = Identifier.of(MedievalStuff.MOD_ID, "textures/gui/forge_controller/melting_progress.png");
    ...
    private static final Identifier ALLOYING_PROGRESS_TEXTURE = Identifier.of(MedievalStuff.MOD_ID, "textures/gui/forge_controller/alloying_progress.png");
    ...
    protected void renderMeltingProgress(DrawContext context, int x, int y) {
        context.drawTexture(MELTING_PROGRESS_TEXTURE, x + 33, y + 34 + 8 - handler.getScaledMeltingProgress(), 0, 8 - handler.getScaledMeltingProgress(), 6, handler.getScaledMeltingProgress(), 6, 8);
    }
