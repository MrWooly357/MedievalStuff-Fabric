...
public class MedievalStuffLootTableGenerator extends FabricBlockLootTableProvider {

    public MedievalStuffLootTableGenerator(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
    ...
    public void generate() {
        ...
        addDrop(MedievalStuffBlocks.REDSTONE_SPAWNER);
    }
